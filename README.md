...
### `📄 NOTAS`
> El bot esta en face de Desarrollo, es posible que se encuentrenalgunas fallas que se iran solucionando segun vallamos encontrando
> Si vas a editar el bot, deja algunos créditos 
> El equpo de VIRUZZ-BOT no se hara cargo si se encuntra una falla en un bot *NO OFICIAL*
> El bot es compatible con Whatsapp normal, y business
> Las actualizaciones oficiales se harán en este repositorio
> El #add y el #kick ocaciona que el numero del bot valla a soporte, por lo tanto sera vajo su responsavilidad activarlo con el comando *#enable restrict*
> El equipo de VIRUZZ-BOT, No se hace responsable del uso, números, privacidad y contenido mandado, usados o gestionados por el usuario o el bot.
